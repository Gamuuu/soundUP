...
import BrandAccordion from '../../../components/catalog/BrandAccordion';
    ...
    useEffect(() => {
        async function fetchProducts() {
            try {
                ...
                // Filter products by item_type
                const filtered = data.filter(p => p.item_type === categoryInfo?.item_type);
